 ...
 */
    ...
    var third_party_assets = {
        css_js: [
            ...
            {"name": "axios", "assets": ["./node_modules/axios/dist/axios.js"]},
            {
    ...
    var app_pages_assets = {
        js: [
            ...
            folder.src + "js/pages/boxicons.init.js",
            folder.src + "js/pages/calendar.init.js",
            folder.src + "js/pages/calendars.init.js",
            ...
            folder.src + "js/pages/schedules.init.js",
            ...
            folder.src + "js/pages/country-state-city.js"
        ]
    };
