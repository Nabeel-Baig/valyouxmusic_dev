    ...
    <div id="uploading-section-artist-mobile" style="display: none">
        <div class="tab-select">
            <div class="carosel-box col-4">
                <div class="row">
                    <div class="col-5 carosel-box-img-div">
                        <img src="{{ asset('assets/images/valyoux/drake-valyou_x_music@2x.png') }}" width="59" height="59"
                            class="rounded-circle avatar-xm m-1" alt="">
                    </div>
                    <div class="col-7 carosel-box-img-div  ">
                        ...
                        <div class="col-12">
                            <p class="uploading-section-artist-mobile-p3"><img
                                    class="uploading-section-artist-mobile--icon-img"
                                    src="{{ asset('assets/images/valyoux/green_arrow_price_going_up.svg') }}"> <span class="text-green"> + $312.3 </span></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="carosel-box col-4">
                <div class="row">
                    <div class="col-5 carosel-box-img-div">
                        <img src="{{ asset('assets/images/valyoux/justin_beiber_valyou_x_music@2x.png') }}" width="59"
                            height="59" class="rounded-circle avatar-xm m-1" alt="">
                    </div>
                    <div class="col-7 carosel-box-img-div  ">
                        <div class="col-12">
            ...
            <div class="carosel-box col-4">
                <div class="row">
                    <div class="col-5 carosel-box-img-div">
                        <img src="{{ asset('assets/images/valyoux/nicky_minaj_valyou_x@2x.png') }}" width="59" height="59"
                            class="rounded-circle avatar-xm m-1" alt="">
                    </div>
                    <div class="col-7 carosel-box-img-div ">
                        <div class="col-12">
                        ...
                        <div class="uploading-section card-body">
                            ...
                            <div class="row for-padd-row">
                                ...
                                <div class="col-lg-8 col-sm-6 col-md-8 padding-n for-btn-post">
                                    <a href="{{ route('admin.upload-video') }}" title="Upload Video">
                                        <img class="uploading-section-upload-img width-40"
                                            src="{{ asset('assets/images/valyoux/video_player.svg') }}">
                                        <img class="uploading-section-upload-img "
                                            src="{{ asset('assets/images/valyoux/news_feed_post.svg') }}">
                                    </a>
                            ...
                            <div class="card margin-n">
                                <div class="post-section card-body">
                                        ...
                                        <div class="col-lg-12 col-12">
                                            <div class="row">
                                                <div class="col-lg-9 col-9 profile_img_name">
                                                    <img class="post-section-artist-img rounded-circle" src="{{ URL::asset($item->user->avatar ?? '') }}" alt="">
                                                <!--</div>-->
                                                <!--<div class="col-lg-7 col-6 post-header-bar">-->
                                                <div class="inner_img_name">
                                                    <p class="post-section-artist-p1 only_name"> {{ $item->user->first_name . ' ' . $item->user->last_name }}</p>
                                    ...
                                    <div class="col-lg-12 col-12 padding-n parent-for-video">
                                        <video id="video{{ $item->id }}" src="{{ asset($item->name) }}" class="video" type="video/mp4"
                                            controls playsinline></video>
                                        <div class="overlay-for-video" id="overlay{{ $item->id }}" data-videoid="{{ $item->id }}" data-userid="{{ $item->user->id }}">
                                            <img src="{{ asset('assets/images/play-button.svg') }}" class="rounded-circle"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="social-media-profile-wrap">
                                        <div class="sm-left-wrap">
                                            <img src="{{ URL::asset($item->user->avatar ?? '') }}" alt=""
                                                class="avatar-md rounded-circle">
                                            <div class="sm-left-desc for_web">
                                                <h2>{{ $item->user->first_name . ' ' . $item->user->last_name }} </h2>
                                                <h5>Artist share price: <span class="color-white">$2.33 VXD </span> <img class="uploading-section-artist-icon-img" src="{{ asset('assets/images/valyoux/green_arrow_price_going_up.svg') }}"> <span class="text-green">+ 0.30%</span></h5>
                                        ...
                                        <div class="sm-right-wrap">
                                            <button type="button" class="btn-invest-pink-grad"
                                                onclick="location.href='{{ url('crypto-exchange') }}'"> Invest in
                                                Artist</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div style="display: none;" id="valyou-music-section-{{ $item->id }}">
                                <div class="container">
                                ...
                                <div class="row ">
                                        ...
                                        <div class="card shadow-none share-valyou-music" data-valyouid="{{ $item->id }}">
                                            <div class="card-body body-p">
                                                <img class="mb-2 share-box-image"
                                                    src="{{ asset('assets/images/valyoux/valyousongiconnew@2x.png') }}">
                                    ...
                                    <div class="col-4 col-md-4 text-center padding-r ">
                                        <div class="card shadow-none share-comments" data-commentid="{{ $item->id }}">
                                            <div class="card-body body-p">
                                                <img class="mb-2 share-box-image"
                                                    src="{{ asset('assets/images/comments.svg') }}">
                                    ...
                                    <div class="col-4 col-md-4 text-center padding-r ">
                                        <div class="card shadow-none share-promote-song" data-promoteid="{{ $item->id }}">
                                            <div class="card-body body-p">
                                                <img class="mb-2 share-box-image"
                                                    src="{{ asset('assets/images/promote.svg') }}">
                                            ...
                                            <div class="row text-center">
                                                ...
                                                <div class="col-md-2 col-2">
                                                    <img style="transform: rotate(90deg);" class="mr-3 comment-btn"
                                                        ...
                                                        src="{{ asset('assets/images/valyoux/green_arrow_price_going_up.svg') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <div class="card text-center">
                                            ...
                                            <div class="card-body price-card">
                                                ...
                                                <div class="quantity">
                                                    ...
                                                    <span class="input-qty pt-3"></span><input type='text' id="quantity{{$item->id}}" name='quantity'
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <img class="mr-3" style="height:30px; width:30px"
                                                src="{{ asset('assets/images/Headphone investor.svg') }}">
                                        </div>
                                        <div class="row mb-5">
                                            <div class="col-md-5">
                                                <h2 class="fw-600">Select How you Promote Song?</h2>
                                                <select id="promoteSong{{$item->id}}" class="form-control promoteSong" data-id="{{ $item->id }}">
                                            ...
                                            <div id="valyoux{{$item->id}}" class="col-md-4 valyoux" style="display: none">
                                                <h2 class="fw-600">Investors on Valyou X </h2>
                                                <select id="promoteuser{{$item->id}}" class="select2 form-control" multiple="multiple">
                                                    @foreach ($users as $user)
                                                        <option value="{{ $user->id }}">{{ $user->first_name." ".$user->last_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div id="email{{$item->id}}" class="col-md-4 email" style="display: none">
                                                <h2 class="fw-600">Email ID</h2>
                                                <input id="promoteemail{{$item->id}}" type="text" data-role="tagsinput"
                                                    placeholder="Add Emails or add multiple and seprate with ,"
                                                    class="form-control" />
                                            </div>
                                            <div id="phone{{$item->id}}" class="col-md-4 phone" style="display: none">
                                                <h2 class="fw-600">Phone number</h2>
                                                <input id="promotephone{{$item->id}}" class="form-control number-input-music" placeholder="Enter Number"
                                                    type="number">
                                            </div>
                                            <div id="else{{$item->id}}" class="col-md-4 else" style="display: none">
                                            ...
                                            <div class="col-md-12 text-center mb-3">
                                                <div class="card client-input shadow-lg">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <input type='text' id="quantity2{{$item->id}}" name='quantity2' value='25'
                                        ...
                                        <div class="col-md-12 text-center ">
                                            <img class="mx-auto mb-2 d-block"
                                                src="{{ asset('assets/images/send-_promote_start.svg') }}" class="img-fluid">
                                            <button type="button" data-id="{{$item->id}}" class="sendStart send_start">Send / Start</button>
                                                    ...
                                                    <ul class="list-inline">
                                                        ...
                                                        <li class="list-inline-item">
                                                            <a href="#" class="social-list-item  text-white ">
                                                                <img src="{{ asset('assets/images/valyou_xemblem.svg') }}"
                                                                    alt="" height="30">
                                                            </a>
                                                        </li>
                                                    </ul>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-2 col-3">
                                                <img class="post-section-artist-img rounded-circle"
                                                    src="{{ URL::asset('assets/images/valyoux/drake-valyou_x_music@2x.png') }}"
                                                    alt="">
                                            </div>
                                            <div class="col-lg-7 col-6 post-header-bar">
                        ...
                        <div style="display: none" id="sharing-section-3">
                            <div class="container">
                                <div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 text-center mb-3">
                                            <div class="card client-input">
                                                <img src="{{ asset('assets/images/send-_promote_start.svg') }}" class="img-fluid">
                                                <div class="card-body">
                                    ...
                                    <div class="col-md-12 text-center ">
                                        <img class="mx-auto mb-2 d-block"
                                            src="{{ asset('assets/images/send-_promote_start.svg') }}">
                                        <h2>Send / Start</h2>
                                        <h5 class="font-size-14 mb-3 text-center">Share it on</h5>
                                        <div class="mt-4 text-center row">
                                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-12">
                                        <div class="row">
                                            <div class="col-lg-2 col-3">
                                                <img class="post-section-artist-img rounded-circle"
                                                    src="{{ URL::asset('assets/images/valyoux/bobby_k9_valyou_x_music250@2x.png') }}"
                                                    alt="">
                                            </div>
                                            <div class="col-lg-7 col-6 post-header-bar">
                                ...
                                <div class="card">
                                    ...
                                    <div class="p-3 chat-input-section">
                                        <div class="row text-center">
                                            <div class="col-md-2 col-2">
                                                <div class="mr-3">
                                                    <img src="{{ URL::asset('assets/images/valyoux/bobby_k9_valyou_x_music250@2x.png') }}"
                                                        alt="" class="avatar-md rounded-circle ">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-2 col-2">
                                                <img style="transform: rotate(270deg);" class="mr-3 comment-btn"
                                                    style="height:30px; width:30px"
                                                    src="{{ asset('assets/images/valyoux/pink_arrow_circle_down.svg') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-12">
                                        <div class="row">
                                            <div class="col-lg-2 col-3">
                                                <img class="post-section-artist-img rounded-circle"
                                                    src="{{ URL::asset('assets/images/valyoux/moniq.png') }}" alt="">
                                            </div>
                                            <div class="col-lg-7 col-6 post-header-bar">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-12">
                                        <div class="row">
                                            <div class="col-lg-2 col-3">
                                                <img class="post-section-artist-img rounded-circle"
                                                    src="{{ URL::asset('assets/images/valyoux/nicky_minaj_valyou_x@2x.png') }}"
                                                    alt="">
                                            </div>
                                            <div class="col-lg-7 col-6 post-header-bar">
                                            ...
                                            <li>
                                                <div class="row">
                                                    <div class="col-md-4 col-12">
                                                        <div class="row artist-comment-image-div">
                                                            <div class="col-md-4 col-2 ">
                                                                <img src="{{ URL::asset('assets/images/valyoux/nicky_minaj_valyou_x@2x.png') }}"
                                                                    alt="" class="avatar-md rounded-circle ">
                                                            </div>
                                                            <div class="col-md-8 col-10 mt-4">
                                                                <p class="text-dark font-size-12 artist-comment-name">Bobby
                    ...
                    <div class="social-post">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-12">
                                        <div class="row">
                                            <div class="col-lg-2 col-3">
                                                <img class="post-section-artist-img rounded-circle"
                                                    src="{{ URL::asset('assets/images/valyoux/pro_artist@2x.png') }}"
                                                    alt="">
                                            </div>
                                            <div class="col-lg-7 col-6 post-header-bar">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="social-media-profile-wrap">
                                    <div class="sm-left-wrap">
                                        <img src="{{ URL::asset('assets/images/valyoux/pro_artist@2x.png') }}" alt=""
                                            ...
                                            <li>
                                                <div class="row">
                                                    <div class="col-md-4 col-12">
                                                        <div class="row artist-comment-image-div">
                                                            <div class="col-md-4 col-2 ">
                                                                <img src="{{ URL::asset('assets/images/valyoux/pro_artist@2x.png') }}"
                                                                    alt="" class="avatar-md rounded-circle ">
                                                            </div>
                                                            <div class="col-md-8 col-10 mt-4">
                                                                <p class="text-dark font-size-12 artist-comment-name">Bobby
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-12">
                                        <div class="row">
                                            <div class="col-lg-2 col-3">
                                                <img class="post-section-artist-img rounded-circle"
                                                    src="{{ URL::asset('assets/images/valyoux/dre-450new.png') }}"
                                                    alt="">
                                            </div>
                ...
                <div class="col-lg-4 col-4">
                    <div class="uploading-section-artist">
                        ...
                        <div class="tab-select nav nav-pills search-bar-web artist-maker-tabs" id="v-pills-tab"
                            ...
                            <a href="#northamerica" class="unclicked" id="northamerica-tab" data-toggle="pill" role="tab"
                                aria-controls="northamerica" aria-selected="false"> America (North)</a>
                            <a href="#africa" class="unclicked" id="africa-tab" data-toggle="pill" role="tab"
                                aria-controls="africa" aria-selected="false"> Africa</a>
                            <a href="#southamerica" class="unclicked" id="southamerica-tab" data-toggle="pill" role="tab"
                                aria-controls="southamerica" aria-selected="false"> South America </a>
                            <a href="#asia" class="unclicked" id="asia-tab" data-toggle="pill" role="tab"
                                aria-controls="asia" aria-selected="false"> Asia </a>
                            <a href="#australia" class="unclicked" id="australia-tab" data-toggle="pill" role="tab"
                                aria-controls="australia" aria-selected="false"> Australia </a>
                            <a href="#europe" class="unclicked" id="europe-tab" data-toggle="pill" role="tab"
                                aria-controls="europe" aria-selected="false"> Europe </a>
                        </div>
                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                            <div id="all" class="tab-pane fade show active" role="tabpanel" aria-labelledby="all-tab">
                                <div class="artist-markets-content-wrap">
                                    <p class="uploading-section-artist-sub-heading text-center light-gray-color"> All
                                        Artists</p>
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-lg-4 col-4">
                                                    <img src="{{ asset('assets/images/valyoux/nicky_minaj_valyou_x@2x.png') }}"
                                                        width="50" height="50" class="rounded-circle avatar-xm m-1" alt="">
                                                </div>
                                                <div class="col-lg-6 col-6 ml-1">
                                                    ...
                                                    <p class="uploading-section-artist-p3"><img
                                                            class="uploading-section-artist-icon-img"
                                                            src="{{ asset('assets/images/valyoux/green_arrow_price_going_up.svg') }}">
                                                        <span class="text-green"> + $312.3 </span></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-lg-4 col-4 ">
                                                    <img src="{{ asset('assets/images/valyoux/beyonce.svg') }}"
                                                        width="50" height="50" class="rounded-circle avatar-xm m-1" alt="">
                                                </div>
                                                <div class="col-lg-6 col-6 ml-1">
                                    ...
                                    <div class="card">
                                        <div class=" card-body">
                                            <div class="row">
                                                <div class="col-lg-4 col-4 ">
                                                    <img src="{{ asset('assets/images/valyoux/justin_beiber_valyou_x_music@2x.png') }}"
                                                        width="50" height="50" class="rounded-circle avatar-xm m-1" alt="">
                                                </div>
                                                <div class="col-lg-6 col-6 ml-1">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-lg-4 col-4 ">
                                                    <img src="{{ asset('assets/images/valyoux/drake-valyou_x_music@2x.png') }}"
                                                        width="50" height="50" class="rounded-circle avatar-xm m-1" alt="">
                                                </div>
                                                <div class="col-lg-6 col-6 ml-1">
                            ...
                            <div id="northamerica" class="tab-pane fade" role="tabpanel" aria-labelledby="northamerica-tab">
                                <div class="artist-markets-content-wrap">
                                    <p class="uploading-section-artist-sub-heading text-center light-gray-color"> North
                                        American Artists</p>
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                            ...
                            <div id="africa" class="tab-pane fade" role="tabpanel" aria-labelledby="africa-tab">
                                <div class="artist-markets-content-wrap">
                                    <p class="uploading-section-artist-sub-heading text-center light-gray-color"> African
                                        Artists</p>
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                            ...
                            <div id="southamerica" class="tab-pane fade" role="tabpanel" aria-labelledby="southamerica-tab">
                                <div class="artist-markets-content-wrap">
                                    <p class="uploading-section-artist-sub-heading text-center light-gray-color"> South
                                        American Artists</p>
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                            ...
                            <div id="asia" class="tab-pane fade" role="tabpanel" aria-labelledby="asia-tab">
                                <div class="artist-markets-content-wrap">
                                    <p class="uploading-section-artist-sub-heading text-center light-gray-color"> Asian
                                        Artists</p>
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                            ...
                            <div id="australia" class="tab-pane fade" role="tabpanel" aria-labelledby="australia-tab">
                                <div class="artist-markets-content-wrap">
                                    <p class="uploading-section-artist-sub-heading text-center light-gray-color"> Australian
                                        Artists</p>
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                            ...
                            <div id="europe" class="tab-pane fade" role="tabpanel" aria-labelledby="europe-tab">
                                <div class="artist-markets-content-wrap">
                                    <p class="uploading-section-artist-sub-heading text-center light-gray-color"> European
                                        Artists</p>
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                        ...
                        <!--				<p class="uploading-section-artist-p1">Nicki Minaj</p>-->
                        <!--				<p class="uploading-section-artist-p2">$112,644,179</p>-->
                        <!--				<p class="uploading-section-artist-p3"><img class="uploading-section-artist-icon-img" src="{{ asset('assets/images/valyoux/green_arrow_price_going_up.svg') }}"> <span class="text-green"> + $312.3 </span></p>-->
                        <!--			</div>-->
                        <!--		</div>-->
                        <!--	</div>-->
                        <!--</div>-->
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p class="popup-text">
                                ...
                                You now have unlimited plays & access to listen to this song. It has now been added to your
                                Valyou Playlist. <br><br>
                                Kind Regards, <br>
                                <b>Artist Name.</b>
                            </p>
                        </div>
