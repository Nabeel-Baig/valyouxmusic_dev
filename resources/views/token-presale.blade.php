        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="topnav-menu-content">
                ...
                <ul class="navbar-nav ml-auto" id="topnav-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="crypto-ico-landing">Buy VXD</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('projects-list') }}">Market</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('socialmedia') }}">Social Media</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('tasks-kanban') }}">Connect</a>
                    </li>
                    <!--<li class="nav-item">-->
