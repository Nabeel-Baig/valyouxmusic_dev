                                ...
                                <div class="modal-body">
                                    <div id="kyc-verify-wizard" class="twitter-bs-wizard">
                                        ...
                                        <ul class="pager wizard twitter-bs-wizard-pager-link new-formodalbtns">
                                            <li class="previous"><a href="#" class="btn-pink waves-effect waves-light btn-sm">Previous</a></li>
                                            <li class="next">
                                                <a href="#" class="btn-green waves-effect waves-light btn-sm" id="noBtnShow">Next</a>
