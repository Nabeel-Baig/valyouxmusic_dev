...
@section('content')
    ...
    @component('common-components.breadcrumb')
        ...
        @slot('li_1') Welcome to Valyou X Dashboard @endslot
    @endcomponent
        ...
        <div class="col-xl-8">
            <div class="row">
                ...
                @component('common-components.index-widget')
                    @slot('title') Currency Exchange @endslot
                ...
                @component('common-components.index-widget')
                    @slot('title') VXD Market Cap @endslot
                    @slot('price') $2,423,456,416.20 @endslot
