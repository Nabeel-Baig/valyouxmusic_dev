...
@section('content')
    ...
    <div class="row tab-margin-top d-none">
        <div class="col-12">
    ...
    <div class="connect-wrapper">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="tab-content connect-tab-content container" id="myTabContent">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="ctc-single-profile">
                                    ...
                                    <a href="artist-profile" class="sph-button">View Profile</a>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="ctc-single-profile">
